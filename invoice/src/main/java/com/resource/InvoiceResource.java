...
public class InvoiceResource {
	...
	public Response getInvoices() {
		...
		return ResponseUtil.generateResponse(200, "success", Invoice.responseKey,invoiceList);
	}
	...
	public Response getInvoice(@PathParam("id") int id) {
		...
		if (invoice != null) {
			return ResponseUtil.generateResponse(200, "Invoice retrival success", Invoice.responseKey, invoice);
		}
